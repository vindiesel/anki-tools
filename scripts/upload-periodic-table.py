...
RAW_PERIODIC_URL = 'https://raw.githubusercontent.com/andrejewski/periodic-table/master/data.csv'
...
def main():
    ...
    periodic = pd.read_csv(RAW_PERIODIC_URL, encoding='utf-8')
    periodic.columns = [column.strip() for column in periodic.columns]
    fields_to_upload = [
    ...
    if num_failures > 0:
        ...
        print(f'All notes successfully added')
