...
RAW_CAPITALS_URL = 'https://gist.githubusercontent.com/mbostock/9535021/raw/902265051e775cd35a6aa6307a23070f739ebed1/us-state-capitals.csv'
...
def main():
    ...
    fields_to_upload = [
        ...
        for _, row in pd.read_csv(RAW_CAPITALS_URL, encoding='utf-8').iterrows()
    ]
    notes_to_upload = [
        {
            'deckName': deck_name,
